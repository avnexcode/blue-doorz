    ...
    <x-slot name="header">
        <div class="flex justify-between">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Update Room ') . str_replace(' ', ' ', ucwords(str_replace('_', ' ', $room->name))) }}
            </h2>
        </div>
    </x-slot>
    <div class="py-12">
                        ...
                        <form action="{{ route('rooms.update', $room->id) }}" method="POST"
                            ...
                            <div class="my-5 flex flex-col">
                                ...
                                <x-text-input id="room_number" class="block mt-1 w-full" type="text"
                                    name="room_number" :value="old('room_number', $room->room_number)" required autofocus autocomplete="off" />
                            ...
                            <div class="my-5 flex flex-col">
                                ...
                                <x-text-input id="price" class="block mt-1 w-full" type="text" name="price"
                                    :value="old('price', $room->price)" required autofocus autocomplete="off" />
                            ...
                            <div class="my-5 flex flex-col gap-2">
                                ...
                                <div class="flex gap-5">
                                    <div class="flex flex-col">
                                        <img src="{{ asset('storage/' . $room->image) }}" alt="Gambar Ruangan"
                            ...
                            <div class="my-5 flex flex-col">
                                ...
                                <textarea class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500" name="description" id="description"
                                    cols="" rows="5" maxlength="10000">{{ $room->description }}</textarea>
